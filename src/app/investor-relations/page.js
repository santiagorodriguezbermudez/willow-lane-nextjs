  ...
  return (
    <div className="container mx-auto py-16">
      <header className="mb-12 text-center">
        <h1 className="text-4xl font-bold text-primary mb-4 font-haboro uppercase">Investor Relations</h1>
        <p className="text-xl text-gray-dark max-w-2xl mx-auto font-thin">
      ...
      <div className="text-center">
        <a 
          ...
          className="text-gray-dark hover:text-primary font-bold py-3 px-6 transition-colors duration-200 font-haboro uppercase"
        >
          View SEC Filings
        </a>
      </div>
